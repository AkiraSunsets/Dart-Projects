          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                HomeActionItem(
                  icon:
                      Icons.credit_card, // Replaced FontAwesomeIcons.creditCard
                  label: "Crédito",
                  onTap: () {
                    Navigator.push(
                      context,
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  const Icon(
                    Icons.credit_card,
                  ), // Replaced FaIcon(FontAwesomeIcons.creditCard)
                  const SizedBox(width: 20),
                  Text(
                    "Meus cartões",
                    style: GoogleFonts.montserrat(
      ...
      children: [
        GestureDetector(
          ...
          child: Container(
            ...
            child: Center(
              child: Icon(icon, size: 24, color: const Color(0xFF800080)),
            ),
          ),
        ),
        const SizedBox(height: 10),
...
class CreditoWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        // Melhor que Column para listas de itens
        ...
        children: [
          ...
          const InstallmentOptionCard(
            title: "1x R\$ 20,54",
            subtitle: "Total: R\$20,54",
          ),
          const InstallmentOptionCard(
            title: "2x R\$ 10,44",
            subtitle: "Total: R\$20,88",
          ),
          const InstallmentOptionCard(
            title: "3x R\$ 7,07",
            subtitle: "Total: R\$21,23",
          ),
        ],
      ),
    );
